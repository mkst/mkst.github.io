...
The operator [asc](http://code.kx.com/q/ref/sort/#asc) is used to sort a list into <b>asc</b>ending order, however if we apply this to the examples, it will sort the list itself, rather than sorting each word in the list.
