...
We know the maximum of the list, but not *where* it occurs in the list. Leveraging some code from **Day 01** allows us to build the following snippet which give us the indices of the list where the maximum occurs:
