...
Now we are cooking with gas! Let's try running this against our [input file](http://adventofcode.com/2017/day/1/input) which should be downloaded and saved to `~/kdb/input/01.txt`.

After a quick look on the KX wiki, [read0](https://code.kx.com/wiki/Reference/read0) is the operator of choice to load the input file into our session.
